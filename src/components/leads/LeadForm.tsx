...
const LeadForm = () => {
  ...
  const InputField = ({ label, name, type = "text", value, onChange, required = false, options = null }: {
    label: string;
    name: string;
    type?: string;
    value: string;
    ...
    <div className="flex flex-col">
      ...
      {options ? (
        <select
          ...
          value={value}
          onChange={onChange}
          className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white transition-all"
          required={required}
        >
            ...
            <div className="bg-white rounded-xl  border-gray-300 border-2 p-6 space-y-6">
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  onChange={handleFormDataChange}
                  rows={3}
                  className="w-full px-3 py-2 border-2 border-gray-200 rounded-md  focus:ring-gray-300 focus:border-2 transition-all"
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        const option = documentOptions.find(opt => opt.value === e.target.value);
                        setSelectedDocument(option || null);
                      }}
