...
import {addleadfield} from '../../api/api'
import {deletefield} from '../../api/api'
import {getleadfield } from '../../api/api'
...
const PROTECTED_COLUMNS = new Set([
  "id","created_at","updated_at","status","lan","partner_loan_id"
]);
        ...
        <tbody>
          {safeCols.map((c) => (
            <tr key={c.name} className="border-b">
              ...
              <td className="py-2">{c.isnullable ? "YES" : "NO"}</td>
              <td className="py-2">
                <button
